...
function cards(requests) {
   ...
   for (let i in requests) {
      ...
      htmlText+= '<div class="card-img-overlay">'
         ...
         if(requests[i].done == true && requests[i].feedback == null) htmlText += '<button value='+ requests[i].request_id +' onclick="currentId=this.value" data-bs-toggle="modal" data-bs-target="#feedback" class="btn btn-primary">Feedback</button>'

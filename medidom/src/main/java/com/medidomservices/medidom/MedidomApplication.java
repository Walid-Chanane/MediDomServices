...
import com.medidomservices.medidom.Repositories.DoctorRepository;
...
public class MedidomApplication {
	...
	@Bean
	public CommandLineRunner commandLineRunner(DoctorRepository doctorRepository, PatientRepository patientRepository){
		return runner -> {
			...
			Doctor tempDoctor = new Doctor("Zitouni", "Zerhouni",new Date(0), (long)58516, "zerhouni@gmail.com", "{noop}zerhouni", Role.EMPLOYEE, 20,"Bab ezzouar",1);
